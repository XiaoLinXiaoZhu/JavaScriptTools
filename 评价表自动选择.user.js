...
(function() {
    ...
    function autoSelect() {
        ...
        // 选择所有"很好"选项（排除已选的"强烈推荐"和"最满意课堂"）
        const goodOptions = document.querySelectorAll('input[type="radio"][value="1_1.0"][score="1.0"]');
        goodOptions.forEach(option => {
            // 排除"强烈推荐"和"最满意课堂"所在的问题组
        ...
        if (submitBtn) {
            ...
            setTimeout(() => {
                ...
                const confirmSelectors = [
                    'a.layui-layer-btn0',           // layui确认按钮
                    'a.popBnt_blue',                // 弹窗蓝色确认按钮
                    '.layui-layer-btn a:first-child' // 另一种layui确认按钮方式
                ];
