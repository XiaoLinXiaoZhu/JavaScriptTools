...
(() => {
  ...
  function vn(t, e, n, s, r) {
    const {
    ...
    } = e, X2 = String(t.key), st2 = Oi(n, t), ct = /* @__PURE__ */ __name((M2, B2) => {
      M2 && Ft(
        M2,
        s,
        9,
    ...
    }, "ct"), It = /* @__PURE__ */ __name((M2, B2) => {
      const Y2 = B2[1];
      ct(M2, B2), P(M2) ? M2.every((T2) => T2.length <= 1) && Y2() : M2.length <= 1 && Y2();
    }, "It"), ft = {
      mode: o,
      persisted: l,
      beforeEnter(M2) {
        ...
        const Y2 = st2[X2];
        Y2 && ee(t, Y2) && Y2.el[Dt] && Y2.el[Dt](), ct(B2, [M2]);
      },
      enter(M2) {
        if (st2[X2] === t) return;
        let B2 = d, Y2 = u, T2 = p;
        if (!n.isMounted)
          if (i)
            B2 = k || d, Y2 = N2 || u, T2 = q2 || p;
          else
            return;
        let z = false;
        M2[ue] = (Rt) => {
          z || (z = true, Rt ? ct(T2, [M2]) : ct(Y2, [M2]), ft.delayedLeave && ft.delayedLeave(), M2[ue] = void 0);
        };
      ...
      leave(M2, B2) {
        ...
        let T2 = false;
        M2[Dt] = (et2) => {
          T2 || (T2 = true, B2(), et2 ? ct(O2, [M2]) : ct(H2, [M2]), M2[Dt] = void 0, st2[Y2] === t && delete st2[Y2]);
        };
        const z = M2[Dt].bind(null, false);
        st2[Y2] = t, F2 ? It(F2, [M2, z]) : z();
      },
      clone(M2) {
        return vn(
          M2,
  ...
  function be(t, e, n, s, r = false) {
    ...
    const i = s.shapeFlag & 4 ? Un(s.component) : s.el, o = r ? null : i, { i: l, r: f } = t, d = e && e.r, u = l.refs === U ? l.refs = {} : l.refs, p = l.setupState, S2 = /* @__PURE__ */ R(p), F2 = p === U ? Ps : (O2) => ns(u, O2) ? false : D(S2, O2), H2 = /* @__PURE__ */ __name((O2, J2) => !(J2 && ns(u, J2)), "H");
    if (d != null && d !== f) {
      if (ss(e), W(d))
        u[d] = null, F2(d) && (p[d] = null);
    ...
    if (K(f))
      ...
      if (O2 || J2) {
        const k = /* @__PURE__ */ __name(() => {
          if (t.f) {
            const N2 = O2 ? F2(f) ? p[f] : u[f] : H2() || !t.k ? f.value : u[t.k];
            if (r)
              P(N2) && Ir(N2, i);
            else if (P(N2))
          ...
          } else O2 ? (u[f] = o, F2(f) && (p[f] = o)) : J2 && (H2(f, t.k) && (f.value = o), t.k && (u[t.k] = o));
        }, "k");
        if (o) {
  ...
  function Vi(t, e) {
    return function(s, r = null) {
      ...
      const d = i.app = {
        ...
        mount(u, p, S2) {
          if (!f) {
            const F2 = d._ceVNode || Mt(s, r);
            return F2.appContext = i, S2 === true ? S2 = "svg" : S2 === false && (S2 = void 0), t(F2, u, S2), f = true, d._container = u, u.__vue_app__ = d, Un(F2.component);
          }
        },
        onUnmount(u) {
          l.push(u);
  ...
  function rs(t) {
    ...
    try {
      ...
      Ce.length = 0, Ye(X2, t, 1), k = Mt(Gt);
    }
    let q2 = k;
    if (N2 && O2 !== false) {
      const X2 = Object.keys(N2), { shapeFlag: st2 } = q2;
      X2.length && st2 & 7 && (i && X2.some(ze) && (N2 = Wi(
        N2,
        i
      )), q2 = Jt(q2, N2, false, true));
    }
    return n.dirs && (q2 = Jt(q2, null, false, true), q2.dirs = q2.dirs ? q2.dirs.concat(n.dirs) : n.dirs), n.transition && Ee(q2, n.transition), k = q2, $e(J2), k;
  }
  __name(rs, "rs");
  ...
  function Ji(t, e, n = false) {
    ...
    if (P(i))
      ...
      for (const d in i) {
        const u = dt(d);
        if (os(u)) {
          const p = i[d], S2 = o[u] = P(p) || K(p) ? { type: p } : lt({}, p), F2 = S2.type;
          let H2 = false, O2 = true;
          if (P(F2))
            for (let J2 = 0; J2 < F2.length; ++J2) {
              const k = F2[J2], N2 = K(k) && k.name;
              if (N2 === "Boolean") {
                H2 = true;
                break;
  ...
  function eo(t, e) {
    ...
    const {
      ...
      for (; c && c !== a; )
        h = S2(c), r(c), c = h;
      r(a);
    }, "X"), st2 = /* @__PURE__ */ __name((c, a, h, x2, g2, m, v2, y2, b2) => {
    ...
    }, "st"), ct = /* @__PURE__ */ __name((c, a, h, x2, g2, m, v2, y2) => {
      let b2, _2;
      ...
      if (b2 = c.el = o(
        ...
        v2,
        y2
      ), A2 && Bt(c, null, x2, "created"), It(b2, c, c.scopeId, v2, x2), E2) {
        for (const L2 in E2)
    ...
    }, "ct"), It = /* @__PURE__ */ __name((c, a, h, x2, g2) => {
      if (h && F2(c, h), x2)
      ...
      if (h && Kt(h, false), (A2 = w2.onVnodeBeforeUpdate) && xt(A2, h, a, c), E2 && Bt(a, c, h, "beforeUpdate"), h && Kt(h, true), (C2.innerHTML && w2.innerHTML == null || C2.textContent && w2.textContent == null) && u(y2, ""), _2 ? B2(
        ...
        if (b2 & 16)
          ...
          for (let L2 = 0; L2 < I2.length; L2++) {
            const $2 = I2[L2], G2 = C2[$2], Z2 = w2[$2];
            (Z2 !== G2 || $2 === "value") && i(y2, $2, G2, Z2, g2, h);
          }
        }
        b2 & 1 && c.children !== a.children && u(y2, a.children);
      } else !v2 && _2 == null && Y2(y2, C2, w2, h, g2);
    ...
    }, "B"), Y2 = /* @__PURE__ */ __name((c, a, h, x2, g2) => {
      if (a !== h) {
        if (a !== U)
          for (const m in a)
            !me(m) && !(m in h) && i(
    ...
    }, "z"), et2 = /* @__PURE__ */ __name((c, a, h, x2, g2, m, v2) => {
      ...
      if (Fi(c) && (y2.ctx.renderer = ce), mo(y2, false, v2), y2.asyncDep) {
        if (g2 && g2.registerDep(y2, oe, v2), !c.el) {
          ...
          k(null, b2, a, h), c.placeholder = b2.el;
        }
      } else
        oe(
          y2,
      ...
      const y2 = /* @__PURE__ */ __name(() => {
        if (c.isMounted) {
          let { next: C2, bu: w2, u: A2, parent: I2, vnode: L2 } = c;
          {
            const mt = gr(c);
            if (mt) {
              C2 && (C2.el = L2.el, Xe(c, C2, v2)), mt.asyncDep.then(() => {
                it(() => {
                  c.isUnmounted || _2();
                }, g2);
              });
          ...
          let $2 = C2, G2;
          Kt(c, false), C2 ? (C2.el = L2.el, Xe(c, C2, v2)) : C2 = L2, w2 && en(w2), (G2 = C2.props && C2.props.onVnodeBeforeUpdate) && xt(G2, I2, C2, L2), Kt(c, true);
          const Z2 = rs(c), gt = c.subTree;
          c.subTree = Z2, O2(
            gt,
            Z2,
            ...
            g2,
            m
          ), C2.el = Z2.el, $2 === null && qi(c, Z2.el), A2 && it(A2, g2), (G2 = C2.props && C2.props.onVnodeUpdated) && it(
            () => xt(G2, I2, C2, L2),
            g2
          );
        } else {
          let C2;
          const { el: w2, props: A2 } = a, { bm: I2, m: L2, parent: $2, root: G2, type: Z2 } = c, gt = ye(a);
    ...
    }, "Xe"), Ze = /* @__PURE__ */ __name((c, a, h, x2, g2, m, v2, y2, b2 = false) => {
      ...
      if (_2 > C2) {
        ...
        for (_2 = I2; _2 <= w2; _2++) {
          const rt2 = a[_2] = b2 ? At(a[_2]) : Ct(a[_2]);
          rt2.key != null && L2.set(rt2.key, _2);
        }
        let $2, G2 = 0;
        const Z2 = w2 - I2 + 1;
        let gt = false, mt = 0;
        const fe = new Array(Z2);
        for (_2 = 0; _2 < Z2; _2++) fe[_2] = 0;
        for (_2 = A2; _2 <= C2; _2++) {
          const rt2 = c[_2];
          if (G2 >= Z2) {
            Nt(rt2, g2, m, true);
          ...
          if (rt2.key != null)
            ...
            for ($2 = I2; $2 <= w2; $2++)
              if (fe[$2 - I2] === 0 && ee(rt2, a[$2])) {
                _t = $2;
                break;
              }
          _t === void 0 ? Nt(rt2, g2, m, true) : (fe[_t - I2] = _2 + 1, _t >= mt ? mt = _t : gt = true, O2(
            rt2,
            a[_t],
            h,
            null,
        ...
        for ($2 = Yn.length - 1, _2 = Z2 - 1; _2 >= 0; _2--) {
          const rt2 = I2 + _2, _t = a[rt2], Gn = a[rt2 + 1], Jn = rt2 + 1 < E2 ? (
      ...
      if ($2 && (G2 = v2 && v2.onVnodeBeforeUnmount) && xt(G2, a, c), E2 & 6)
        ...
        (m !== ut || C2 > 0 && C2 & 64) ? le(
          ...
          false,
          true
        ) : (m === ut && C2 & 384 || !g2 && E2 & 16) && le(b2, a, h), x2 && kn(c);
      }
      const Z2 = I2 != null && A2 == null;
      ($2 && (G2 = v2 && v2.onVnodeUnmounted) || L2 || Z2) && it(() => {
        G2 && xt(G2, a, c), L2 && Bt(c, null, a, "unmounted"), Z2 && (c.el = null);
      }, h);
    ...
    const qn = /* @__PURE__ */ __name((c, a, h) => {
      ...
      c == null ? a._vnode && (Nt(a._vnode, null, null, true), x2 = a._vnode.component) : O2(
        ...
        null,
        h
      ), a._vnode = c, Qe || (Qe = true, es(x2), tr(), Qe = false);
    }, "qn"), ce = {
      p: O2,
      um: Nt,
      m: Pe,
  ...
  function Eo(t) {
    ...
    } = e, M2 = /* @__PURE__ */ __name((T2, z, et2, Rt) => {
      T2._enterCancelled = Rt, $t(T2, z ? u : l), $t(T2, z ? d : o), et2 && et2();
    }, "M"), B2 = /* @__PURE__ */ __name((T2, z) => {
      T2._isLeaving = false, $t(T2, p), $t(T2, F2), $t(T2, S2), z && z();
    }, "B"), Y2 = /* @__PURE__ */ __name((T2) => (z, et2) => {
      const Rt = T2 ? It : N2, oe = /* @__PURE__ */ __name(() => M2(z, T2, et2), "oe");
      zt(Rt, [z, oe]), ps(() => {
    ...
    return lt(e, {
      onBeforeEnter(T2) {
        zt(k, [T2]), bt(T2, i), bt(T2, o);
      },
      onBeforeAppear(T2) {
        zt(ct, [T2]), bt(T2, f), bt(T2, d);
      },
      onEnter: Y2(false),
      onAppear: Y2(true),
      onLeave(T2, z) {
        T2._isLeaving = true;
        const et2 = /* @__PURE__ */ __name(() => B2(T2, z), "et");
        bt(T2, p), T2._enterCancelled ? (bt(T2, S2), En(T2)) : (En(T2), bt(T2, S2)), ps(() => {
          T2._isLeaving && ($t(T2, p), bt(T2, F2), hs(X2) || gs(T2, s, J2, et2));
        }), zt(X2, [T2, et2]);
      },
      onEnterCancelled(T2) {
  ...
  function wr(t, e) {
    ...
    const F2 = u === Lt && /\b(?:transform|all)(?:,|$)/.test(
...
` + cl, document.head.appendChild(e), Ms = true;
  ...
  var F = typeof CSS < "u" && CSS.supports && CSS.supports("line-height", "mod(1,1)");
  ...
  var Y = /* @__PURE__ */ __name((s, t) => {
    !customElements.get(s) && customElements.define(s, t);
  }, "Y");
  function Z(s, t, { reverse: e = false } = {}) {
    const i = s.length;
  ...
  function q(s, t, e, i) {
    ...
    for (const u of n) {
      ...
      c === "integer" ? (f = true, r.push(...u.value.split("").map((k) => ({ type: c, value: parseInt(k) })))) : c === "group" ? r.push({ type: c, value: u.value }) : c === "decimal" ? (p = true, o.push({ type: c, value: u.value, key: l(c) })) : c === "fraction" ? o.push(...u.value.split("").map((k) => ({
        type: c,
        value: parseInt(k),
        key: l(c),
        pos: -1 - h[c]
  ...
  var _J = class _J {
    constructor(t, e, i, { className: n, ...a } = {}) {
      this.flow = t, this._integer = new j2(t, e, {
        justify: "right",
        part: "integer"
      }), this._fraction = new j2(t, i, {
        justify: "left",
        part: "fraction"
      }), this._inner = v("span", {
  ...
  var tt2 = Q2();
  var et = "number-flow-connect";
  var it2 = "number-flow-update";
  var _nt = class _nt extends P2 {
    constructor() {
      super(...arguments), this.connected = false;
    }
    connectedCallback() {
      this.connected = true, this.dispatchEvent(new Event(et, { bubbles: true }));
    }
  ...
  var cardObserver = new MutationObserver((mutations) => {
    for (const mutation of mutations) {
      mutation.addedNodes.forEach((node) => {
        ...
        const el2 = node;
        const cards = el2.classList.contains("bili-video-card") ? [el2] : Array.from(el2.querySelectorAll(".bili-video-card"));
